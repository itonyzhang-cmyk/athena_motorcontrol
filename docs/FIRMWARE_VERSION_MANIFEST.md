...
当前主线指针为 `cyberdog-safe-bringup@61b6666709827d02d5f21bc4c8a76795a1be6847`。
该提交只对齐文档 provenance；下面的正式 BIN 仍由其明确记录的源提交构建。
...
- 当前主线 HEAD（仅文档修正后）：`61b6666709827d02d5f21bc4c8a76795a1be6847`
